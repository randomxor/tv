...
Lampa.SettingsApi.addParam({
    ...
    onChange: function (value) {
     ...
     if (value == 'own') Lampa.Storage.set('jackett_url', 'http://77.91.86.50:9117')&Lampa.Storage.set('jackett_key', 'kufs9hw8b4jv824qdwf6u93wn9fnti3s')&Lampa.Storage.set('jackett_interview','all')&Lampa.Storage.set('parse_in_search', false)&Lampa.Storage.set('parse_lang', 'lg');
